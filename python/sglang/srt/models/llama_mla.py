...
from sglang.srt.utils import add_prefix, make_layers, BumpAllocator
...
class LlamaDecoderLayer(nn.Module):
    def __init__(
        ...
        # Set default values for DeepseekV2AttentionMLA
    ...
    def forward(
        ...
        # Create a zero allocator for DeepseekV2AttentionMLA
...
class LlamaModel(nn.Module):
    ...
    def forward(
        ...
        # Create a BumpAllocator for DeepseekV2AttentionMLA
        zero_allocator = BumpAllocator(
